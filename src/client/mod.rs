...
pub trait Reader: Client {
    ...
    async fn read_device_identification(&mut self, _: ReadDeviceIdCode, _: ObjectId) -> Result<(ConformityLevel,MoreFollows,NextObjectId,Vec<ReadDevIdObject>), Error>;
}
...
impl Reader for Context {
    ...
    async fn read_device_identification<'a>(
        ...
        object_id: ObjectId) -> Result<(ConformityLevel,MoreFollows,NextObjectId,Vec<ReadDevIdObject>), Error>
    {
        let rsp = self
            .client
